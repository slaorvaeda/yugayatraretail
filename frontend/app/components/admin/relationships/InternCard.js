...
const InternCard = ({ intern, onViewHistory, onAddTouchpoint, onViewDetails }) => {
  return (
    <div className="flex h-full flex-col rounded-3xl border border-slate-100 bg-white/85 p-6 shadow-[0_20px_40px_-30px_rgba(15,23,42,0.25)] backdrop-blur">
      <div className="flex items-start justify-between gap-4">
        <div>
          <h4 className="text-lg font-semibold text-slate-900">{intern.full_name}</h4>
