       ...
       >
        ...
        <div className="relative z-10 p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col h-full overflow-hidden">
          ...
          >
             ...
             <button 
               className="bg-gray-500 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-xl font-semibold text-base sm:text-lg hover:bg-gray-600 hover:scale-105 hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg cursor-not-allowed order-1 sm:order-2"
              data-aos="zoom-in"
              data-aos-delay="800"
              disabled
            >
